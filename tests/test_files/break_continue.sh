...
#testcase "break 2 nested loops" "-c" "for i in a b; do for j in 1 2; do echo \$i\$j; break 2; done; echo not_ok; done"
#testcase "continue 2 nested loops" "-c" "for i in a b; do for j in 1 2; do continue 2; echo not_ok; done; echo ok; done"
